              ...
              children: [
                ...
                Column(
                  children:  [
                    PrayerTimeRow(
                      prayerName: "Fajr",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.fajrStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.fajrEnd.toString())}",
                    ...
                    PrayerTimeRow(
                      prayerName: "Dhuhr",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.dhuhrStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.dhuhrEnd.toString())}",
                      isCurrentPrayer: false,
                    ),
                    PrayerTimeRow(
                      prayerName: "Asr",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.asrStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.asrEnd.toString())}",
                      isCurrentPrayer: false,
                    ),
                    PrayerTimeRow(
                      prayerName: "Maghrib",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.maghribStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.maghribEnd.toString())}",
                      isCurrentPrayer: false,
                    ),
                    PrayerTimeRow(
                      prayerName: "Isha",
                ...
                Column(
                  children:  [
                    PrayerTimeRow(
                      isCurrentPrayer: false,
                      prayerName: "Morning",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.dawnStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.dawnEnd.toString())}",
                    ),
                    PrayerTimeRow(
                      prayerName: "Noon",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.noonStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.noonEnd.toString())}",
                      isCurrentPrayer: false,
                    ),
                    PrayerTimeRow(
                      prayerName: "Evening",
                      timeRange: "${convertUtcToLocalTime(state.prayerTimesResponse.eveningStart.toString())} - ${convertUtcToLocalTime(state.prayerTimesResponse.eveningEnd.toString())}",
                      isCurrentPrayer: false,
                    ),
                  ],
                ),
