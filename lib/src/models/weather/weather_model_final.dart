...
/// coord : {"lon":89.3661,"lat":24.8463}
/// weather : [{"id":800,"main":"Clear","description":"clear sky","icon":"01d"}]
/// base : "stations"
/// main : {"temp":42.07,"feels_like":39.06,"temp_min":42.07,"temp_max":42.07,"pressure":1002,"humidity":10,"sea_level":1002,"grnd_level":1000}
/// visibility : 10000
/// wind : {"speed":3.46,"deg":318,"gust":6.53}
/// clouds : {"all":0}
/// dt : 1681723440
/// sys : {"country":"BD","sunrise":1681688341,"sunset":1681734302}
/// timezone : 21600
/// id : 1207870
/// name : "Chak Brindāban"
/// cod : 200

class WeatherModelFinal {
  WeatherModelFinal({
      Coord? coord, 
  ...
  WeatherModelFinal.fromJson(dynamic json) {
  ...
  String? _name;
  num? _cod;
WeatherModelFinal copyWith({  Coord? coord,
  List<Weather>? weather,
  String? base,
  Main? main,
  num? visibility,
  ...
  String? name,
  num? cod,
}) => WeatherModelFinal(  coord: coord ?? _coord,
...
Main copyWith({  num? temp,
  ...
  Map<String, dynamic> toMap() => {
    ...
    'feels_like': jsonEncode(feelsLike),
    'temp_min':jsonEncode(tempMin),
    'temp_max':jsonEncode(tempMax),
    'pressure':jsonEncode(pressure),
    'humidity':jsonEncode(humidity),
    'sea_level':jsonEncode(seaLevel),
    'grnd_level':jsonEncode(grndLevel),
  };

  factory Main.fromMap(Map<String, dynamic> sWeather) =>Main(
    temp: jsonDecode(sWeather["temp"]),
    feelsLike: jsonDecode(sWeather["feels_like"]),
    tempMin: jsonDecode(sWeather["temp_min"]),
    tempMax: jsonDecode(sWeather["temp_max"]),
    pressure: jsonDecode(sWeather["pressure"]),
    humidity: jsonDecode(sWeather["humidity"]),
    seaLevel: jsonDecode(sWeather["sea_level"]),
    grndLevel: jsonDecode(sWeather["grnd_level"]),
