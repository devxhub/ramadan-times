                                ...
                                child: Padding(
                                        ...
                                        CustomTextField(
                                          ...
                                          suffixIcon: GestureDetector(
                                            onTap: () {
                                              context
                                                  .read<SignInBloc>()
                                                  .add(SignInEvent.isConfirmPasswordObscure());
                                            },
                                            child: Icon(
                                  ...
                                  obscureText: state.isNewPasswordObscure,
                                      ...
                                      SizedBox(height: 16.h),
                                        CustomTextField(
                                          editingController: resetPasswordController,
                                          ...
                                          suffixIcon: GestureDetector(
                                            onTap: () {
                                              context
                                                  .read<SignInBloc>()
                                                  .add(SignInEvent.isConfirmNewPasswordObscure());
                                            },
                                            child: Icon(
                                              state.isConfirmNewPasswordObscure == true
                                                  ? Icons.visibility_off
                                                  : Icons.visibility,
                                              color: HexColor("#75718B"),
                                            ),
