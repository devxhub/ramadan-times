                                  ...
                                  PinCodeTextField(
                                    ...
                                    pinTheme: PinTheme(
                                      ...
                                      activeFillColor: Colors
                                          .white, // Background color for active field
                                      selectedFillColor: Colors
                                          .white, // Background color for selected field
                                      inactiveFillColor: Colors.grey[
                                          200]!, // Background for inactive fields
                                      activeColor: Colors
                                          .blue, // Border color when active
                                      selectedColor: Colors
                                          .blue, // Border color when selected
                                      inactiveColor: Colors
                                          .transparent, // No border for inactive fields
                                    ),
                                    enableActiveFill:
                                        true, // Enables the fill color
                                  ),
